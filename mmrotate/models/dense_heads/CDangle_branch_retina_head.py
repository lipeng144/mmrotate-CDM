...
class CDAngleBranchRetinaHead(RetinaHead):
    """retina head with cdm regression branch.
    ...
    def loss_by_feat_single(self, cls_score: Tensor, bbox_pred: Tensor,
        ...
        if self.use_encoded_angle:
           angle_emd_pred = self.angle_coder.decode(angle_pred)
           bbox_pred[..., -1] = angle_emd_pred
