...
data_root = 'D:/pythondata/mmrotate-1.x/tools/data/dota/split/DOTA_split/'
backend_args = None
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=metainfo,
        data_root=data_root,
        ann_file='trainsplit/train.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=metainfo,
        data_root=data_root,
        ann_file='valsplit/val.json',
        data_prefix=dict(img='valsplit/images/'),
        test_mode=True,
