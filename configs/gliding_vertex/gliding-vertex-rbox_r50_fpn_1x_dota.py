# _base_ = [
#     '../_base_/datasets/dota_qbox.py', '../_base_/schedules/schedule_1x.py',
#     '../_base_/default_runtime.py'
# ]
_base_ = [
    'D:/pythondata/mmrotate-1.x/configs/_base_/datasets/rsdd_qbox.py', 'D:/pythondata/mmrotate-1.x/configs/_base_/schedules/schedule_3x.py',
